                ...
                <Typography variant="body1" color="text.secondary" paragraph sx={{ lineHeight: 1.6 }}>
                  ...
                  <Box sx={{ display: 'flex', gap: 3, mb: 3 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      ...
                      <Typography variant="body2">Free shipping over $75</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          <Paper elevation={2}>
            ...
            <Box sx={{ px: 4 }}>
              <TabPanel value={tabValue} index={0}>
                ...
                <Typography variant="body1" paragraph sx={{ lineHeight: 1.8 }}>
                  Built for fans who live orange and blue. Officially licensed by the NBA and crafted
                  with the same quality and attention to detail you'd expect from the official team
                  store — because game day is every day.
                </Typography>
              </TabPanel>
              ...
              <TabPanel value={tabValue} index={1}>
                <Grid container spacing={2}>
                  ...
                  <Grid size={{ xs: 12, sm: 6 }}>
                    ...
                    <Typography variant="body1" paragraph>Free over $75</Typography>
                  </Grid>
                </Grid>
              </TabPanel>
